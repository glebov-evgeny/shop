<template>
  <div class="card" @click="onCardClick">
    <svg viewBox="0 0 128 32" class="card__logo">
      <path
    ...
    <p class="card__title">Подарочная карта Nintendo eShop</p>
    <div class="card__line"></div>
    <p class="card__region">{{ regionsCurrentText }}</p>
    <div class="card__price">
      <p class="card__nominal">{{ card.nominal }} {{ curretValue }}</p>
      <p class="card__cost">
        Цена: <span>{{ card.price }}</span> &#8381;
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    onCardClick() {
      this.$emit('cardClickHandler', this.card);
    },
  },
};
</script>
